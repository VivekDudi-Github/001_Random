...
import {Ten_Days_Forecast_card , Container} from "../../../index"
...
function Ten_Days_Forecast() {
  ...
  return (
    <>
      ...
      <div role="status" className =" fixed filter-none z-50 -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 scale-150 ">
    ...
    <Container>
        <div className=' w-full md:m-1  bg-transparent'>
            ...
            <h2 className='mt-2 text-center bg-white'>Errro:Free-Trial-over_restricted-to-limited-forecast</h2>
        </div>
