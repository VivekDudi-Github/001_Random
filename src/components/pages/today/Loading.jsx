...
<>
    { IsLoading ? <div role="status" className =" fixed filter-none z-50 -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 -scale-150 ">
      <svg aria-hidden="true" class="w-9 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   <div className={IsLoading? `blur-lg` : "" }>
    <Container>
            <div className=' w-full md:m-5   bg-white'>
