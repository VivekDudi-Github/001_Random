...
<>
    ...
    <Container>
           <div className=' flex flex-col w-full  md:m-5'>
            <div className='md:ml-5 m-1 h-5 flex flex-wrap '>
              <button className='m-1 p-1 bg-blue-500 rounded-lg duration-200 hover:bg-blue-900 hover:text-white active:text-white active:scale-90 '
              
              >Precipitation</button>
              <button className='m-1 p-1 bg-blue-500 rounded-sm '>Precipitation</button>
              <button className='m-1 p-1 bg-blue-500 rounded-sm '>Precipitation</button>
              <button className='m-1 p-1 bg-blue-500 rounded-sm '>Precipitation</button>
              <button className='m-1 p-1 bg-blue-500 rounded-sm '>Precipitation</button>
             
            </div>
                  <div className={` border-gray-500 border-2 rounded-lg md:h-full h-96 w-full m-1 md:mt-1 md:m-5 duration-200  bg-white ${IsLoading? `blur-sm` : "" } ` }>
                  { IsLoading ? <h1>Searching into cordinates</h1>:<SimpleMap  />} 
